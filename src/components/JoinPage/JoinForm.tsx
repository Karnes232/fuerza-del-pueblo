...
import { membershipTiers, interestAreas, availabilityOptions } from '@/config/unete.config';
    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div>
        ...
        <div className="space-y-3">
          {membershipTiers.map((tier) => (
            <label key={tier.id} className="flex items-start gap-3 cursor-pointer">
              <input
                type="radio"
                name="membershipType"
                value={tier.id}
      ...
      <div className="space-y-3">
        ...
        <FormCheckbox
          ...
          onChange={(checked) => setFormData({...formData, receiveUpdates: checked})}
        />
      </div>
